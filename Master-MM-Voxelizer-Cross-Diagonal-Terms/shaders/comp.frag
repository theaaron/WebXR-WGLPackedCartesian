...
void main(){
    ...
    vec4 UNORTH = texelFetch( vlt_txtr, unpack( NORTH ), 0 ) ; 
    vec4 USOUTH = texelFetch( vlt_txtr, unpack( SOUTH ), 0 ) ; 
    vec4 UEAST  = texelFetch( vlt_txtr, unpack( EAST  ), 0 ) ;
    vec4 UWEST  = texelFetch( vlt_txtr, unpack( WEST  ), 0 ) ;
    vec4 UUP    = texelFetch( vlt_txtr, unpack( UP    ), 0 ) ;
    vec4 UDOWN  = texelFetch( vlt_txtr, unpack( DOWN  ), 0 ) ;
    vec4 UCENTER= texelFetch( vlt_txtr, texelPos       , 0 ) ;   
    vec4 UMS12  = texelFetch( vlt_txtr, unpack( MS12 ) , 0 ) ; 
    vec4 UPS12  = texelFetch( vlt_txtr, unpack( PS12 ) , 0 ) ; 
    vec4 UMS13  = texelFetch( vlt_txtr, unpack( MS13 ) , 0 ) ; 
    vec4 UPS13  = texelFetch( vlt_txtr, unpack( PS13 ) , 0 ) ; 
    vec4 UMS21  = texelFetch( vlt_txtr, unpack( MS21 ) , 0 ) ; 
    vec4 UPS21  = texelFetch( vlt_txtr, unpack( PS21 ) , 0 ) ; 
    vec4 UMS23  = texelFetch( vlt_txtr, unpack( MS23 ) , 0 ) ; 
    vec4 UPS23  = texelFetch( vlt_txtr, unpack( PS23 ) , 0 ) ; 
    vec4 UMS31  = texelFetch( vlt_txtr, unpack( MS31 ) , 0 ) ; 
    vec4 UPS31  = texelFetch( vlt_txtr, unpack( PS31 ) , 0 ) ; 
    vec4 UMS32  = texelFetch( vlt_txtr, unpack( MS32 ) , 0 ) ; 
    vec4 UPS32  = texelFetch( vlt_txtr, unpack( PS32 ) , 0 ) ; 
