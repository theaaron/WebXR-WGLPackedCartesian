...
//            0 ).xy ;
    ...
    uvec2 targetIndex = uvec2( getIJ(checkPoint, size ) ) ;
...
void main(){
    ...
    /* uncompressed version */
    ivec2 fullTexelIndx = ivec2( cc*vec2(fullSize) ) ;
    ivec4 compTexelIndx = ivec4( texelFetch(   compressedTexelIndex,
                                                fullTexelIndx,
                                                0                   ) ); 
    ...
    // compressed
    //if ( fullTexelIndx.a != 1 ){

    // uncompressed
    if ( compTexelIndx.a != 1 ){
        return ;
    }
    
    // 3-dimentional index of the of texel ...............................
    ivec3 cidx = getIdx( fullTexelIndx.xy , size ) ;
